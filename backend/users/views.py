...
class CustomUserViewSet(UserViewSet):
    ...
    def subscribe(self, request, id):
        ...
        if request.method == "DELETE" and Follow.objects.filter(**data).exists():
    ...
    def subscriptions(self, request):
        ...
        result = paginator.paginate_queryset(queryset=following, request=request)
        context = {"request": request}
        serializer = UserWithRecipesSerializer(result, many=True, context=context)
